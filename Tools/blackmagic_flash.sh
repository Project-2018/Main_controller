...
/home/dani/GCC/gcc-arm-none-eabi-5_4-2016q3/bin/arm-none-eabi-size $elf || exit 1
...
/home/dani/GCC/gcc-arm-none-eabi-5_4-2016q3/bin/arm-none-eabi-gdb $elf --batch -x $tmpfile
rm $tmpfile
